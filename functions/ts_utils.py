...
class MinialTotalSegmentator():
    def __init__(self, verbose=False):
        ...
        os.environ['nnUNet_raw'] = '/home/user/.totalsegmentator/nnunet/results'
        os.environ['nnUNet_preprocessed'] = '/home/user/.totalsegmentator/nnunet/results'
        os.environ['nnUNet_results'] = '/home/user/.totalsegmentator/nnunet/results'
        ...
        model_training_output_dir = '/home/user/.totalsegmentator/nnunet/results/Dataset297_TotalSegmentator_total_3mm_1559subj/nnUNetTrainer_4000epochs_NoMirroring__nnUNetPlans__3d_fullres'
